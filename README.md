...
학교 급식, 시간표, 학사일정을 한곳에서 확인하려고 만든 iOS 앱입니다.  
아이폰 앱을 중심으로 홈 화면 위젯과 Apple Watch 화면도 함께 구성되어 있습니다.
...
- 급식과 학사일정은 교육청 API를 사용합니다.
- 시간표는 교육청 API 또는 컴시간 중에서 선택할 수 있습니다.
- 주말에는 컴시간 기준 시간표가 비어 있도록 처리되어 있습니다.

개인적으로 쓰려고 시작한 프로젝트라, 배포보다는 실제로 쓰기 편한 쪽에 맞춰 계속 손보고 있습니다.
